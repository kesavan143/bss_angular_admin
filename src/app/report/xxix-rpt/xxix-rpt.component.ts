...
@Component({
  selector: 'app-xxix-rpt',
  templateUrl: './xxix-rpt.component.html',
  styleUrls: ['./xxix-rpt.component.scss']
})
export class XXIXRptComponent implements OnInit {
  data: any = [];
  companylist: any;
  site_names: any;
  datas: any;
  ...
  exportAsXLSX():void {
    this.excelService.exportAsExcelFile(this.data, 'FORM No. XXIX');
  }
  print(cmpName) {
