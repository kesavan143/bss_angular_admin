...
@Component({
  selector: 'app-view-training-reoprt',
  templateUrl: './view-training-reoprt.component.html',
  styleUrls: ['./view-training-reoprt.component.scss']
})
export class ViewTrainingReoprtComponent implements OnInit {
  ...
  this.route.params.subscribe(params => {
      ...
      this.httpService.post('https://bssservice.herokuapp.com/training/fetchtrainingreport',{id:+this.site_id}).subscribe((data:any)  => {
  ...
  table(id){
   console.log(id)
   this.httpService.post('https://bssservice.herokuapp.com/training/listtrainingreporttable',{report_id:+this.site_id}).subscribe((data:any)  => {
    this.trainglist = data.data;
    console.log(this.trainglist);
   });
  }
