...
@Component({
  selector: 'app-viewqualitycheck',
  templateUrl: './viewqualitycheck.component.html',
  styleUrls: ['./viewqualitycheck.component.scss']
})
export class ViewqualitycheckComponent implements OnInit {
  ...
  this.route.params.subscribe(params => {
      ...
      this.httpService.post('https://bssservice.herokuapp.com/quality/fetchquality',{id:+this.site_id}).subscribe((data:any)  => {
  ...
  table(id){
   console.log(id)
   this.httpService.post('https://bssservice.herokuapp.com/quality/listqualitytable',{quality_id:+this.site_id}).subscribe((data:any)  => {
