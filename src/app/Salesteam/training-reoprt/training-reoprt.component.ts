...
@Component({
  selector: 'app-training-reoprt',
  templateUrl: './training-reoprt.component.html',
  styleUrls: ['./training-reoprt.component.scss']
})
export class TrainingReoprtComponent implements OnInit {
  ...
  this.route.params.subscribe(params => {
      ...
      this.httpService.post('https://bssservice.herokuapp.com/training/listtrainingreport',{id:+this.site_id}).subscribe((data:any)  => {
  ...
  view(event, item){
    this.router.navigate(['main/viewTrainingReoprt/' + item.id])
  }
